...
function NotificationCard({data, index, notificationState}) {
  ...
  const {seen, type, reply, comment, createdAt, replied_on_comment, user, user:{personal_info:{profile_img, fullname, username}}, blog: {_id, blog_id, title}, _id:notification_id} = data;
