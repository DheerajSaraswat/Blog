...
function NotificationCard({data, index, notificationState}) {
  ...
  let {seen, type, reply, comment, createdAt, replied_on_comment, user, user:{personal_info:{profile_img, fullname, username}}, blog: {_id, blog_id, title}, _id:notification_id} = data;
  ...
  let handleDelete = (comment_id, type, target) => {
